...
CREATE OR REPLACE FUNCTION FN_LISTAR_MANTENCION_DEPA RETURN SYS_REFCURSOR IS
  CUR_LISTAR_MANTENCION_DEPA SYS_REFCURSOR;
BEGIN OPEN CUR_LISTAR_MANTENCION_DEPA FOR SELECT * FROM MANTENCION_DEPARTAMENTO;
  RETURN CUR_LISTAR_MANTENCION_DEPA; 
  CLOSE CUR_LISTAR_MANTENCION_DEPA;
END;
...
CREATE OR REPLACE FUNCTION FN_LISTAR_RESERVA_DEPA RETURN SYS_REFCURSOR IS
  CUR_LISTAR_RESERVA_DEPA SYS_REFCURSOR;
BEGIN OPEN CUR_LISTAR_RESERVA_DEPA FOR SELECT * FROM RESERVA_DEPARTAMENTO;
  RETURN CUR_LISTAR_RESERVA_DEPA;
  CLOSE CUR_LISTAR_RESERVA_DEPA;
END;
...
CREATE OR REPLACE FUNCTION FN_LISTAR_SERVICIO_DEPA RETURN SYS_REFCURSOR IS
  CUR_LISTAR_SERVICIO_DEPA SYS_REFCURSOR;
BEGIN OPEN CUR_LISTAR_SERVICIO_DEPA FOR SELECT * FROM SERVICIO_DEPARTAMENTO;
  RETURN CUR_LISTAR_SERVICIO_DEPA;
  CLOSE CUR_LISTAR_SERVICIO_DEPA;
END;
