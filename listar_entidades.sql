...
BEGIN OPEN CUR_LISTAR_ESTADO_INMUEBLE FOR SELECT * FROM ESTADO_INMUEBLE;
...
---------------------------------------------
-- Función listar servicios básicos
---------------------------------------------

CREATE OR REPLACE FUNCTION FN_LISTAR_SERVICIOS_BASICOS RETURN SYS_REFCURSOR IS
  CUR_LISTAR_SERVICIOS_BASICOS SYS_REFCURSOR;
BEGIN OPEN CUR_LISTAR_SERVICIOS_BASICOS FOR SELECT * FROM SERVICIOS_BASICOS;
  RETURN CUR_LISTAR_SERVICIOS_BASICOS;
  CLOSE CUR_LISTAR_SERVICIOS_BASICOS;
END;
...
CREATE OR REPLACE FUNCTION FN_LISTAR_SERVICIOS_EXTRA RETURN SYS_REFCURSOR IS
  CUR_LISTAR_SERVICIOS_EXTRA SYS_REFCURSOR;
BEGIN OPEN CUR_LISTAR_SERVICIOS_EXTRA FOR SELECT * FROM SERVICIOS_EXTRA;
  RETURN CUR_LISTAR_SERVICIOS_EXTRA;
  CLOSE CUR_LISTAR_SERVICIOS_EXTRA;
END;

---------------------------------------------
-- Función listar zona inmueble
---------------------------------------------
